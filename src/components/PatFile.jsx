...
import PatVisitors from "./patVisitors";

const PatFile = forwardRef(({ patient }, ref) => {
    ...
    >
      ...
      <div className="flex space-x-8">
        ...
        {currentStaff.role !== "Orderly" && (
          ...
          >
            {showInv ? "Close Invoice" : "Show invoice"}
          </button>
        )}
      ...
      {/* Visitors */}
      {showVisitors && <PatVisitors patientId={patientId} />}
    </div>
  );
});

PatFile.displayName = "PatFile";

export default PatFile;
